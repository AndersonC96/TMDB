...
$ctp = curl_init();
curl_setopt($ctp, CURLOPT_URL, "http://api.themoviedb.org/3/tv/on_the_air?api_key=" . $apikey  . "&language=pt-BR");
...
$ctr = curl_init();
curl_setopt($ctr, CURLOPT_URL, "http://api.themoviedb.org/3/tv/top_rated?api_key=" . $apikey . "&language=pt-BR");
