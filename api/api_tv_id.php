<?php
    $cti = curl_init();
    curl_setopt($cti, CURLOPT_URL, "http://api.themoviedb.org/3/tv/".$id_tv."?api_key=" . $apikey  . "&language=pt-BR");
    ...
    $cti2 = curl_init();
    curl_setopt($cti2, CURLOPT_URL, "http://api.themoviedb.org/3/tv/".$id_tv."/videos?api_key=" . $apikey  . "&language=pt-BR");
    ...
    $cti3 = curl_init();
    curl_setopt($cti3, CURLOPT_URL, "http://api.themoviedb.org/3/tv/".$id_tv."/similar?api_key=" . $apikey  . "&language=pt-BR");
