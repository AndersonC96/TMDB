<?php
    $cz = curl_init();
    curl_setopt($cz, CURLOPT_URL, "http://api.themoviedb.org/3/movie/".$id_movie."/recommendations?api_key=" . $apikey . "&language=pt-BR");
    ...
    curl_close($cz);
    $movie_recommendations_id = json_decode($response99);
?>